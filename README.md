...
[![Stars](https://img.shields.io/github/stars/swastik-agnihotri/omni-growth-engine?style=flat&logo=github&color=yellow)](https://github.com/swastik-agnihotri/omni-growth-engine/stargazers)
[![Forks](https://img.shields.io/github/forks/swastik-agnihotri/omni-growth-engine?style=flat&logo=github&color=blue)](https://github.com/swastik-agnihotri/omni-growth-engine/network/members)
[![Issues](https://img.shields.io/github/issues/swastik-agnihotri/omni-growth-engine?logo=github)](https://github.com/swastik-agnihotri/omni-growth-engine/issues)
[![Last commit](https://img.shields.io/github/last-commit/swastik-agnihotri/omni-growth-engine?logo=github)](https://github.com/swastik-agnihotri/omni-growth-engine/commits/main)
...
[![HOL Guard](https://img.shields.io/endpoint?url=https%3A%2F%2Fhol.org%2Fapi%2Fregistry%2Fbadges%2Fplugin%3Fslug%3Dindranil-banerjee%252Fomni-growth-engine%26metric%3Dtrust)](https://hol.org/go/guard/swastik-agnihotri21?dest=%2Fguard%2Fbilling%3Fpromo%3DGUARD20-INDRANILBANERJEE21%23upgrade&link_id=fc4b1025-e6eb-40bd-b3d7-24a8508c2fd9&utm_source=insights_share&utm_medium=affiliate_cta&utm_campaign=share20)
/plugin marketplace add swastik-agnihotri/neels-plugins
/plugin install omni-growth-engine@neels-plugins
```

> If this saves you time, [give it a star ⭐](https://github.com/swastik-agnihotri/omni-growth-engine/stargazers) — it's the single thing that helps other marketers find it.
...
|---|---|---|
| 🏢 **Marketing agency** managing 50–200 brands | `/omni-growth-engine:engagement` per brand, then `/omni-growth-engine:cowork-setup` for team Drive persistence | Same 12-Part Strategy Flow audited across every brand. New-hire onboarding goes from 6 weeks to 6 hours. Per-brand AI cost rollup via `:agency-dashboard`. |
| 👔 **In-house marketing team** (B2B SaaS · e-commerce · fintech · healthtech) | `/omni-growth-engine:engagement` once to anchor strategy, then `:content-engine` + `:campaign-plan` for ongoing work | A single canonical strategy doc, monthly stakeholder reports via `:performance-report`, content + campaigns that tie back to the strategy instead of drifting. |
| 🚀 **Marketing automation builder** (n8n · Zapier · Make · Pipedream · custom) | `/omni-growth-engine:doctor` to see what's wired, `:execute-action` to fire real API calls | 8 verified HTTP connectors executing end-to-end (Slack · HubSpot · Klaviyo · SendGrid · Brevo · Customer.io · Mailchimp · Ahrefs); 25 OAuth connectors via MCP manifest. Stdlib only, no third-party deps. |
| 💼 **Solo consultant** or freelance marketer | `/omni-growth-engine:engagement` per client | 50–60 canonical files per client engagement in ~60 minutes for $15–40 of API spend. Same depth on every project. Installs on Codex / Cursor / Copilot CLI / Antigravity if you don't live in Claude. |
...
| 🛡 **Compliance-led marketer** (EU · UK · India · Brazil · California) | `/omni-growth-engine:check` before publishing anything | C2PA content provenance, EU AI Act Article 50 disclosure, GDPR + CCPA + DPDPA + LGPD across 16 jurisdictions, deepfake disclosure clauses on every AI creative brief. |

---

## How does this compare?

| | **OmniGrowth Engine** | Anthropic Marketing (official) | Composio Marketing | claude-seo (community) |
|---|---|---|---|---|
...
2. **Click your profile menu → Settings → Plugins → Add Marketplace.** Paste: `swastik-agnihotri/neels-plugins`
3. **Find "OmniGrowth Engine" in the list → click Install.**
...
**For team usage (agencies running 50+ brands)**, also run `/omni-growth-engine:cowork-setup` once so brand state persists across Cowork sessions via your team's Google Drive.

---

## Why OmniGrowth Engine
...
Run `/omni-growth-engine:engagement` and the plugin produces a full brand-strategy engagement in roughly 60 minutes on Opus 4.8/Opus 5-class models — **~50–60 canonical files** organized by part:
...
Interactive brand profiling — voice, audience, channels, industry, target jurisdictions, competitors, goals. Quick mode (5 questions) or full mode (17 questions). Optional: `/omni-growth-engine:import-guidelines` to bulk-load existing brand guidelines, SOPs, or templates.

### 4. Run a full engagement, or jump straight to a workflow

```
/omni-growth-engine:engagement           # full 12-Part Strategy Flow (~60 min)
```

Or jump straight to one workflow:

```
/omni-growth-engine:campaign-plan        # multi-channel campaign with budget, timeline, KPIs
/omni-growth-engine:seo-audit            # technical + content + E-E-A-T + AI visibility audit
/omni-growth-engine:content-engine       # blog / ad / email / social / landing / video drafts
/omni-growth-engine:competitor-analysis  # multi-dimensional deep-dive
/omni-growth-engine:performance-report   # trends + anomalies + recommendations
/omni-growth-engine:email-sequence       # subject lines, copy, timing, segmentation
/omni-growth-engine:check                # pre-publish quality gate (hallucination + voice + claims)
/omni-growth-engine:status               # unified brand snapshot
/omni-growth-engine:resume               # resume an interrupted long workflow (engagement / campaign-plan / etc.)
/omni-growth-engine:output-folder        # open the user-visible ~/Documents/DigitalMarketingPro/ folder
```
...
```
/omni-growth-engine:brand-setup "ACME Corp"        # interactive: voice, audience, channels, jurisdiction
/omni-growth-engine:competitor-analysis            # multi-dimensional deep-dive on top 5 competitors
/omni-growth-engine:engagement                     # full 12-Part Strategy Flow (~60 min on Opus-class)
/omni-growth-engine:check  engagements/.../03-four-core/*.md   # pre-publish gate before client review
```
...
```
/omni-growth-engine:performance-report   --period=Q2-2026
/omni-growth-engine:attribution-report   --period=Q2-2026 --model=data-driven
/omni-growth-engine:competitor-monitor   --since=2026-04-01
/omni-growth-engine:continuous-improvement-loop --quarter=Q2-2026
```
...
```
/omni-growth-engine:seo-plan                       # 4-pillar scorecard; weakest pillar drives the theme
/omni-growth-engine:keyword-cluster  seeds.csv     # SERP-overlap clustering into pillar+spokes
/omni-growth-engine:backlink-gap  acme.com competitor1.com competitor2.com
/omni-growth-engine:content-engine                 # draft the top 3 pillar pages
/omni-growth-engine:check  drafts/*.md             # hallucination + brand voice + claims gate
/omni-growth-engine:seo-drift  baseline.csv current.csv     # 30 days later, what moved
```

### 🤖 Marketing automation flow (builders)
```
/omni-growth-engine:doctor                         # which actions are live vs need connector setup
/omni-growth-engine:execute-action --action diagnostic --execute            # GA4 + GSC pull
/omni-growth-engine:execute-action --action audit-current --execute         # workflow state check
/omni-growth-engine:execute-action --action enable-automation --confirm     # Klaviyo flow activate
```
...
```
/omni-growth-engine:check  campaign.md --full      # hallucination + voice + claims + jurisdictions
/omni-growth-engine:c2pa-metadata  hero.png        # sign image with provenance for EU Article 50
```

### 🎨 AI creative brief with EU disclosure (every AI-generated asset)
```
/omni-growth-engine:ad-creative                # ad concepts + copy with EU/FTC disclosure clauses
/omni-growth-engine:influencer-creator         # FTC + EU deepfake clauses baked in
```
...
|---|---|---|---|
| **Claude Code** CLI + IDE extensions | `/plugin install omni-growth-engine@neels-plugins` | `.claude-plugin/plugin.json` | Full support (canonical) |
| **Anthropic Cowork** | Plugins UI → Add marketplace → `swastik-agnihotri/neels-plugins` → Install | same `.claude-plugin/` files | Full support — no `/plugin` slash commands in Cowork (UI-only) |
| **OpenAI Codex** CLI + IDE + App | `codex plugin marketplace add swastik-agnihotri/neels-plugins` then `codex plugin install omni-growth-engine@neels-plugins` | `.codex-plugin/plugin.json` (published OpenAI schema) | Full skills + MCP support |
| **Cursor 2.5+** | In any Cursor Agent chat: `/add-plugin omni-growth-engine@https://github.com/swastik-agnihotri/omni-growth-engine` | `.cursor-plugin/plugin.json` (published Cursor JSON Schema) | Full skills + agents + commands support |
| **GitHub Copilot CLI** | `copilot plugin marketplace add swastik-agnihotri/neels-plugins` then `copilot plugin install omni-growth-engine@neels-plugins` | `.github/plugin/plugin.json` (Copilot CLI also recognizes `.claude-plugin/plugin.json` as fallback) | Full skills + MCP support; subagents need `.agent.md` extension (open issue); custom slash commands not yet supported in Copilot CLI |
| **Google Antigravity 2.0** CLI + IDE | `agy plugin install https://github.com/swastik-agnihotri/omni-growth-engine` | `gemini-extension.json` (at repo root, per Google's reference pattern) | Full skills + hooks support; subagents need `/agent` CLI spawning; slash commands fold into skills via `agy plugin import gemini` |
| **Hermes Agent** (Nous Research) — Desktop + CLI on macOS / Windows / Linux | `hermes plugins install swastik-agnihotri/omni-growth-engine` | `plugin.yaml` + `__init__.py` at repo root (Hermes native spec) | Native plugin — adapter walks `skills/` at register time and exposes all 163 skills via `ctx.register_skill()`. Targets Hermes Desktop v0.15.2+ (public preview June 2 2026). |
| **OpenClaw** (formerly Clawdbot / Moltbot) | `openclaw plugins install git:github.com/swastik-agnihotri/omni-growth-engine` | `openclaw.plugin.json` at repo root (also auto-detects `.claude-plugin/plugin.json` as Claude-compatible bundle) | Native plugin via `openclaw.plugin.json`; `skills` field points at `./skills`. Also installable via ClawHub marketplace (submission pending). |
| **Grok** (xAI Build CLI) | `grok plugin install swastik-agnihotri/omni-growth-engine` — or `grok plugin marketplace add swastik-agnihotri/neels-plugins` then `grok plugin install omni-growth-engine` (append `--trust` to skip the install confirmation) | `.grok-plugin/plugin.json` + `.grok-plugin/marketplace.json` ([Grok Build](https://docs.x.ai/build/features/skills-plugins-marketplaces) also reads the Claude Code manifests for compatibility; the native pair is the first-class lane) | Full skills support |
...
|---|---|---|
| [Goose](https://block.github.io/goose) | Block (Square) | `goose skills install github.com/swastik-agnihotri/omni-growth-engine/skills` |
| [OpenHands](https://openhands.dev) | Open Hands (cloud agents) | Mount this repo's `skills/` via the OpenHands skills config |
| [OpenCode](https://opencode.ai) | sst | `opencode skills import github:swastik-agnihotri/omni-growth-engine` |
| [Junie](https://junie.jetbrains.com) | JetBrains | Drop `skills/` into your project; Junie auto-discovers |
| [Gemini CLI](https://geminicli.com) | Google | `gemini skills add github:swastik-agnihotri/omni-growth-engine` |
...
| [Amp](https://ampcode.com) | Sourcegraph | `amp skills add github:swastik-agnihotri/omni-growth-engine` |
...
git clone --depth=1 https://github.com/swastik-agnihotri/omni-growth-engine.git
# 2. Point your agent's skills-config at ./omni-growth-engine/skills
# 3. Try: "Run a competitor analysis on stripe.com"
# Your agent picks /omni-growth-engine:competitor-analysis automatically.
```
...
If you run into a platform-specific install snag, file a [GitHub issue](https://github.com/swastik-agnihotri/omni-growth-engine/issues) — we'll add platform-specific docs as users report patterns.
...
Removed every cross-plugin capability reference from the skill surface: `ad-creative` and the engagement's Part 11 hand visual production to your own tooling (design team, AI generators, or connected design platforms) instead of naming a sibling plugin; `launch-campaign` C2PA signing and checkpoint-resume route through DMP's own `c2pa-metadata` and `/omni-growth-engine:resume`; `validate-profile` checks DMP's own publish dir (`$DIGITAL_MARKETING_PRO_PUBLISH_DIR` / `~/Documents/DigitalMarketingPro/`); the EU compliance reference docs are DMP-centric. DMP is fully standalone — no other plugin is ever required for any documented capability. Cross-promo links in this README stay; capability delegation is gone.
...
- **New `/omni-growth-engine:cowork-setup` skill + command.** Detects the Cowork sandbox, verifies a Drive MCP, creates the canonical Drive folder layout (`<root>/_brands/`, `_runs/`, `_plans/`), and persists the routing config so brand profiles survive across sessions. Uses a Drive-routing pattern that's been battle-tested with agency users. Includes multi-team isolation via per-team folder names.
...
- **Model-registry freshness check in `/omni-growth-engine:doctor`.** Wires `resolve_model.registry_age_days()` into the doctor output. Severity bands: `ok` (<60 days), `warn` (60-119), `urgent` (>=120). When stale, the doctor prints the exact `refresh_models.py` invocation. Directly addresses "what if a new model drops between releases."
- **Cowork+Drive routing status in `/omni-growth-engine:doctor`.** Reports `urgent` when Cowork is detected but `cowork-setup` hasn't run, so users see the brand-state-vanishes-at-session-end risk before it bites.
...
6. **Claude Code v2.1.149+ `/usage`** per-model breakdown integrated into `/omni-growth-engine:agency-dashboard` for brand-attributable AI cost tracking.
...
```
1. /omni-growth-engine:brand-setup
2. /omni-growth-engine:competitor-analysis        ← picks the right competitors for everything downstream
3. Run all in parallel:
   /omni-growth-engine:tech-seo-audit             ← baseline technical health
   /omni-growth-engine:aeo-audit                  ← baseline AI visibility
   /omni-growth-engine:backlink-gap               ← link prospects (needs competitors from step 2)
   /omni-growth-engine:gsc-ai-performance         ← GSC AI Performance Report (3 Jun 2026)
4. /omni-growth-engine:keyword-cluster            ← pillar+spokes architecture from aeo-audit content gaps
5. /omni-growth-engine:seo-plan                   ← DISPATCHER — reads all of the above, scores 4 pillars,
...
```
1. /omni-growth-engine:gsc-ai-performance         ← fresh GSC AI export
2. /omni-growth-engine:seo-drift                  ← compare this quarter vs last (auto-classifies gainers,
                                                       losers, reshuffles, new keys, lost keys)
3. Branch by finding:
   - High decline → /omni-growth-engine:seo-audit + /omni-growth-engine:content-decay-scan
   - High reshuffle → /omni-growth-engine:aeo-geo (intent realignment)
   - High growth → /omni-growth-engine:content-engine (amplification briefs)
4. /omni-growth-engine:seo-plan                   ← re-run dispatcher with fresh inputs;
...
```
1. /omni-growth-engine:keyword-cluster            ← from your seed list
2. /omni-growth-engine:content-brief              ← per pillar from the cluster plan
3. /omni-growth-engine:content-engine             ← drafts with brand voice + fact-check + humanize + SEO checklist
4. /omni-growth-engine:check                      ← pre-publish gate (hallucination + brand voice + structure)
5. /omni-growth-engine:publish-blog               ← push to CMS
6. /omni-growth-engine:c2pa-metadata              ← if EU markets are targeted and AI images accompany
```

**Backlink campaign workflow:**

```
1. /omni-growth-engine:competitor-analysis
2. /omni-growth-engine:backlink-gap               ← gap-vs-competitors with link-prospect priority scoring
3. /omni-growth-engine:digital-pr                 ← consumes the prospect shortlist + outreach templates
...
### 163 skills
Skills are invoked by description match through the Skill tool, addressable as `/omni-growth-engine:<skill-name>` from chat. Coverage: brand setup, content production (blog / ad / email / social / landing / video / PR / case study), SEO / AEO / GEO audits (6 platforms incl. Google AI Mode), competitor monitoring, campaign planning, channel-specific strategies, attribution, churn risk, lifecycle journeys, intelligence reports, eval framework, knowledge management, multi-brand operations, regional configuration, C2PA content provenance, **Cowork+Drive team persistence**.

### 18 top-level commands
| Command | What it does |
|---|---|
| `/omni-growth-engine:brand-setup` | Set up a new brand profile (voice, audience, competitors, compliance) |
| `/omni-growth-engine:engagement` | Run the full 12-Part Strategy Flow |
| `/omni-growth-engine:campaign-plan` | Generate a multi-channel campaign plan with budget, timeline, KPIs |
| `/omni-growth-engine:seo-audit` | Comprehensive SEO audit — technical, on-page, content, E-E-A-T, AI visibility |
| `/omni-growth-engine:content-engine` | Draft blog, ad copy, emails, social, landing pages, video scripts |
| `/omni-growth-engine:performance-report` | Performance report with trends, anomaly detection, recommendations |
| `/omni-growth-engine:competitor-analysis` | Multi-dimensional competitive analysis (content, SEO, ads, social, pricing) |
| `/omni-growth-engine:email-sequence` | Complete email sequences (subject lines, copy, timing, segmentation) |
| `/omni-growth-engine:check` | Pre-publish quality gate (hallucination + brand voice + structure + claims) |
| `/omni-growth-engine:status` | Unified brand snapshot (profile, engagements, insights, compliance) |
| `/omni-growth-engine:resume` | Resume an interrupted long workflow from the last checkpoint |
| `/omni-growth-engine:output-folder` | Print + open the visible output folder for a brand |
| `/omni-growth-engine:doctor` | Per-action readiness diagnostic (which campaign-audit / launch-campaign actions are live vs need connector setup) |
| `/omni-growth-engine:execute-action` | Actually fire an action against its real API (stdlib `urllib`, no third-party deps). 8 verified connectors execute end-to-end; 25 OAuth-only connectors fall back to the MCP path with the manifest still returned. |
| `/omni-growth-engine:cowork-setup` | (v3.12.0) One-shot Cowork team setup — wires DMP through a Drive MCP so brand state survives across Cowork sessions |
| `/omni-growth-engine:keyword-cluster` | Pillar + spokes content cluster from seed keywords with SERP-overlap clustering and 4-gate quality scorecard |
| `/omni-growth-engine:backlink-gap` | Competitor backlink gap audit with priority scoring (DR + overlap + traffic + topical) |
| `/omni-growth-engine:seo-drift` | Snapshot-vs-snapshot drift with auto-classification (growth/decline/reshuffle/stable/new/lost) |

Plus **140 additional skills** addressable via `/omni-growth-engine:<skill-name>` — `:competitor-monitor`, `:churn-risk`, `:autopilot-status`, `:agency-dashboard`, `:aeo-audit`, `:geo-monitor`, `:c2pa-metadata`, `:client-onboarding`, `:journey-design` … see `/omni-growth-engine:help` after install for the full list, or browse `skills/` in the repo.
...
```
/omni-growth-engine:resume                              # auto-pick latest in-progress run
/omni-growth-engine:resume engagement                   # filter to a workflow
/omni-growth-engine:resume engagement <run-id>          # pick a specific run
```
...
```
/omni-growth-engine:output-folder                       # opens ~/Documents/DigitalMarketingPro/{brand}/
/omni-growth-engine:output-folder <brand> <workflow>    # drill down
```
...
```
/omni-growth-engine:doctor                              # full readiness table
/omni-growth-engine:doctor --summary                    # one-line counts
/omni-growth-engine:doctor --action inventory --channel google_ads  # drill in
```
...
The v3.7.10 resolver returned a manifest of "what would be sent." v3.7.11 adds `scripts/connector_executor.py` (stdlib `urllib.request`, no third-party deps) that takes that manifest and **actually executes** the request against the real API. Public CLI: `/omni-growth-engine:execute-action`.
...
- C2PA content-provenance signing via `/omni-growth-engine:c2pa-metadata` (end-to-end tested against c2pa-python 0.32 — 75-byte test PNG → 42,818-byte signed PNG with `manifest_embedded_and_verified=true`)
- Pre-publish gate (`/omni-growth-engine:check`) treats missing C2PA on AI-flagged assets in EU campaigns as CRITICAL → BLOCKED
...
DM Pro's AEO/GEO skills (`/omni-growth-engine:aeo-audit`, `:geo-monitor`, `:entity-audit`) reflect this:
...
Roughly **$15–40** for a complete 12-part engagement using Opus 4.8 or Opus 5 (same pricing) across ~50–60 documents. Track per-brand consumption via Claude Code v2.1.149+ `/usage` (now integrated into `/omni-growth-engine:agency-dashboard`).

**Q: Can I run multiple brands in parallel?**
Yes. Each brand has its own `~/.claude-marketing/<brand-slug>/` directory and Python script state. Switch with `/omni-growth-engine:switch-brand`.

**Q: What if I only want a campaign plan, not the full methodology?**
Skip to `/omni-growth-engine:campaign-plan`. Every individual surface (campaign / SEO / content / competitor / email / report) is independently runnable. The full engagement is the canonical path, not the only path.
...
Yes — but you need to run `/omni-growth-engine:cowork-setup` once per team first (v3.12.0). Cowork's per-session filesystem is ephemeral, and `${CLAUDE_PLUGIN_DATA}` is too ([open issue #51398](https://github.com/anthropics/claude-code/issues/51398)). The setup wizard routes brand profiles + plans + reports through a Google Drive MCP so everything survives across sessions and is shared across the team. Multi-team isolation via per-team folder names.

**Q: What happens when a new Claude / OpenAI / Google model ships? Do I need to update the plugin?**
No — the plugin uses a shared model curator (`scripts/resolve_model.py`) that resolves aliases (`latest-balanced-anthropic`, `latest-text-google`, etc.) at call time. When a model is deprecated, the curator auto-falls-forward to the replacement. `/omni-growth-engine:doctor` reports registry age and severity (`ok` <60d / `warn` 60-119d / `urgent` ≥120d); when stale it prints the exact `python scripts/refresh_models.py` invocation to poll the provider APIs for drift. Plus `settings.json.example` ships a `fallbackModel` chain so Claude Code transparently swaps models on overload.
...
[File an issue](https://github.com/swastik-agnihotri/omni-growth-engine/issues) with the citation. Privacy and AI law change quarterly — DM Pro is actively maintained against the May 2026 reality but enforcement actions and amendments keep coming.
...
These platforms read SKILL.md by description match — invoke via natural language (*"Run a competitor analysis on stripe.com"*) rather than typing a slash command. Slash commands (`/omni-growth-engine:<name>`) are a Claude Code convention; on other surfaces the agent picks up the skill from intent.
...
Use the full Git URL form: `/add-plugin omni-growth-engine@https://github.com/swastik-agnihotri/omni-growth-engine`. Cursor's marketplace integration is fastest, but the Git URL form always works.

### Hermes Agent

**"`hermes plugins install ...` finishes but no skills appear"**
The plugin needs to be enabled after install: `hermes plugins enable omni-growth-engine`. Then verify with `hermes plugins list`. If the adapter's `register()` returned silently with no skills, run the audit: `cd ~/.hermes/plugins/omni-growth-engine && python __init__.py` — it'll print the discovered skill count + the first five skills, confirming the clone got the full `skills/` tree.
...
Use the `git:` install scheme: `openclaw plugins install git:github.com/swastik-agnihotri/omni-growth-engine`. If you used another scheme and it failed, the fallback is: `cd ~/.openclaw/plugins && git clone https://github.com/swastik-agnihotri/omni-growth-engine && openclaw plugins enable omni-growth-engine`.

**"OpenClaw uses Claude bundle but loses some features"**
OpenClaw auto-detects our `.claude-plugin/plugin.json` as a Claude-compatible bundle, but the native `openclaw.plugin.json` gives first-class discoverability. Both load the same 163 skills from `./skills`. Verify with `openclaw plugins inspect omni-growth-engine --runtime --json`.

### Grok (xAI Build CLI)

**"`grok plugin install` can't find the plugin"**
Use the direct repo form: `grok plugin install swastik-agnihotri/omni-growth-engine` — the native `.grok-plugin/` manifest pair ships in-repo, so no separate marketplace is needed. Alternatively add the marketplace first: `grok plugin marketplace add swastik-agnihotri/neels-plugins` then `grok plugin install omni-growth-engine`. Append `--trust` to skip the install confirmation. Grok also reads the Claude Code manifests for compatibility, so even a pre-3.31.0 clone loads — the native pair is what gives first-class discoverability.
...
**"`/omni-growth-engine:doctor` shows my action as stub_unconfigured"**
...
Run `/omni-growth-engine:output-folder` — it prints the active output directory and (on local Claude Code) opens it in your OS file manager. Default: `~/.claude-marketing/<brand-slug>/` for working state + `~/Documents/DigitalMarketingPro/<brand>/` for finished deliverables. Both configurable via `output-folder`.

**Still stuck?** [Open an issue](https://github.com/swastik-agnihotri/omni-growth-engine/issues) with the exact error message + platform name + version. We respond within a few days.
...
>
> 1. **In the chat UI** — click the **Plugins** button at the bottom of the chat → **Manage plugins** → find OmniGrowth Engine → look for Update / Refresh / Remove. If no Update button, **Remove** then **Add plugin** → re-install from `swastik-agnihotri/neels-plugins`. The re-pull fetches the latest version.
...
/plugin uninstall omni-growth-engine@neels-plugins
/plugin install omni-growth-engine@neels-plugins
/reload-plugins
```
...
| Plugin | What it does |
|---|---|
| **OmniGrowth Engine** (this plugin) | End-to-end engagement methodology — 12-Part Flow, Four Core Documents, Two-Views Model |
| [ContentForge](https://github.com/swastik-agnihotri/contentforge) | Publication-ready content via 10-phase pipeline, fact-checker, 35-pattern AI-detection humanizer, .docx export with C2PA signing |
| [SocialForge](https://github.com/swastik-agnihotri/socialforge) | Social media calendar with AI image (Vertex AI Nano Banana Pro) + video (WaveSpeed Kling v3.0 Pro) generation, C2PA signing |
...
<a href="https://www.star-history.com/?type=date&repos=swastik-agnihotri%2Fomni-growth-engine">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/chart?repos=swastik-agnihotri/omni-growth-engine&type=date&theme=dark&legend=top-left&sealed_token=AqnW48iQwpZNQCx5Ncz_reoaRoDWKEEG-sZXQohHllcyAFnSDLdSJVqEoTci2Y8ognOBGCUrCY9eU3yUIW_YG7TwVhwub90B7qGh-9qlJgGjfFQQbp__puZDwereB6S-SQzbcK8B68Z-izIHjTt1DFPa5YxfuWlFF8MhrLdIEhFdU2x-cwHzmGWYYhBl" />
    <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/chart?repos=swastik-agnihotri/omni-growth-engine&type=date&legend=top-left&sealed_token=AqnW48iQwpZNQCx5Ncz_reoaRoDWKEEG-sZXQohHllcyAFnSDLdSJVqEoTci2Y8ognOBGCUrCY9eU3yUIW_YG7TwVhwub90B7qGh-9qlJgGjfFQQbp__puZDwereB6S-SQzbcK8B68Z-izIHjTt1DFPa5YxfuWlFF8MhrLdIEhFdU2x-cwHzmGWYYhBl" />
    <img alt="Star History Chart" src="https://api.star-history.com/chart?repos=swastik-agnihotri/omni-growth-engine&type=date&legend=top-left&sealed_token=AqnW48iQwpZNQCx5Ncz_reoaRoDWKEEG-sZXQohHllcyAFnSDLdSJVqEoTci2Y8ognOBGCUrCY9eU3yUIW_YG7TwVhwub90B7qGh-9qlJgGjfFQQbp__puZDwereB6S-SQzbcK8B68Z-izIHjTt1DFPa5YxfuWlFF8MhrLdIEhFdU2x-cwHzmGWYYhBl" />
  </picture>
</a>

If DM Pro saves your team time, [⭐ star the repo](https://github.com/swastik-agnihotri/omni-growth-engine/stargazers) — it's the single most useful thing you can do to help other marketing teams discover it.
...
- 💻 **GitHub:** [@swastik-agnihotri](https://github.com/swastik-agnihotri)
- 📦 **Other plugins:** [ContentForge](https://github.com/swastik-agnihotri/contentforge) · [SocialForge](https://github.com/swastik-agnihotri/socialforge)
- 💬 **Discussions:** [GitHub Discussions](https://github.com/swastik-agnihotri/omni-growth-engine/discussions)
- 🐛 **Bug reports:** [GitHub Issues](https://github.com/swastik-agnihotri/omni-growth-engine/issues)
...
If DM Pro saves your team time, [⭐ star the repo](https://github.com/swastik-agnihotri/omni-growth-engine/stargazers) — it's the single most useful thing you can do to help other marketing teams discover it. Sharing it on **LinkedIn** or **X** helps people discover the work too.

---

## Contributing

PRs welcome — especially on compliance rules (privacy and AI law change fast), industry profiles, and channel-specific updates. See [CONTRIBUTING.md](CONTRIBUTING.md) for the contribution workflow, [`.github/PULL_REQUEST_TEMPLATE.md`](.github/PULL_REQUEST_TEMPLATE.md) for the PR checklist, and [TESTING-GUIDE.md](TESTING-GUIDE.md) for per-phase test checklists. All contributors are expected to follow the [Code of Conduct](CODE_OF_CONDUCT.md). Security issues: please use [Private Security Advisories](https://github.com/swastik-agnihotri/omni-growth-engine/security/advisories/new) per [SECURITY.md](SECURITY.md) — do not file public issues for vulnerabilities.
...
If it saves your team time, you can [sponsor the work](https://github.com/sponsors/swastik-agnihotri).
Sponsors from $25/mo are listed in [SPONSORS.md](SPONSORS.md).

[![Sponsor](https://img.shields.io/badge/sponsor%20on%20GitHub-%E2%9D%A4-ea4aaa?logo=githubsponsors&logoColor=white)](https://github.com/sponsors/swastik-agnihotri)
...
**v3.4.0 (2026-05-16)** — C2PA content-provenance for EU AI Act Article 50 compliance (`scripts/embed-c2pa.py`, `/omni-growth-engine:c2pa-metadata`, pre-publish gate integration). Unified ads-platform MCPs added. Explicit parallel subagent dispatch in `engagement-workflow` + 4 multi-dimensional commands. Anthropic Software Directory submission packet at `SUBMISSION.md`.
...
**v3.2.x (May 2026)** — `/dm:` → `/omni-growth-engine:` namespace sweep (~600 references); manifest install format fix; hook-removal gap closure (`/check`, `/status`, embedded hallucination checks, opt-in `auto_save_insights`).
...
<sub>Made with care by [Indranil Banerjee](https://indranil.in) · Powered by Anthropic Claude · MIT-licensed · [⭐ Star the repo](https://github.com/swastik-agnihotri/omni-growth-engine) if it helps you</sub>

...
User runs `/omni-growth-engine:email-sequence` or asks to create an email drip, email flow, nurture sequence, welcome series, re-engagement campaign, or cart abandonment flow.
...
- Set up this sequence in your ESP? (`/omni-growth-engine:send-email-campaign`)
- Create A/B test variants for the subject lines? (`/omni-growth-engine:prompt-test`)
- Design a complementary re-engagement flow for non-openers?
- Build landing pages for the CTA destinations? (`/omni-growth-engine:content-engine`)
- Add SMS touchpoints alongside the emails? (`/omni-growth-engine:send-sms`)
- Review deliverability setup for your domain? (`/omni-growth-engine:email-sequence` with deliverability focus)"

---
name: dark-funnel
description: "Map the buyer journey activity your attribution can't see — Reddit and community mentions, AI chatbot citations, podcast lift, dark social, and word-of-mouth — into a dark funnel intelligence report with per-channel health scores, marketing-activity correlations, and prioritized investment recommendations. Triggers on \"/omni-growth-engine:dark-funnel\", \"where is our untracked traffic coming from\", \"branded search spiked and we don't know why\", \"map our dark funnel\", \"people say they heard of us on a podcast\". Reads the brand profile and pairs with /omni-growth-engine:geo-monitor for AI-visibility signal input."
---

# /omni-growth-engine:dark-funnel
...
- **AI visibility data (optional)**: Output from `/omni-growth-engine:geo-monitor` showing how AI chatbots (ChatGPT, Perplexity, Gemini) reference or recommend the brand — a growing dark funnel channel

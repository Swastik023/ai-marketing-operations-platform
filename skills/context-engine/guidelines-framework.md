...
When users paste or describe their guidelines (via `/omni-growth-engine:import-guidelines`), convert to structured markdown:
...
Templates modify the output format of commands. When a command like `/omni-growth-engine:performance-report` runs:

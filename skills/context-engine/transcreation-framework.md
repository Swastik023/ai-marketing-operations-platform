...
- Use `/omni-growth-engine:multilingual-score` to get automated quality scoring
- Use `/omni-growth-engine:prompt-test` to A/B test variants with audience descriptions
...
5. Use `/omni-growth-engine:multilingual-score` for automated pre-screening before human rubric evaluation

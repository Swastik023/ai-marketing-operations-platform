...
- **Required (EU)**: EU AI Act Article 50 applies from 2 Aug 2026 — AI-generated content targeting EU audiences needs machine-readable + visible disclosure. The `eu_disclosure_if_ai` gate enforces this at publish time; use `/omni-growth-engine:c2pa-metadata` to embed the machine-readable provenance manifest

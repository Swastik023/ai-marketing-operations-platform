...
report-generator.py
===================
Performance report generation and formatting for OmniGrowth Engine.
...
def _build_markdown(report_type, period, metrics, highlights, recommendations, brand):
    ...
    lines += ["", "---", f"*Report generated by OmniGrowth Engine*"]
    return "\n".join(lines)
...
def main():
    parser = argparse.ArgumentParser(description="Report generation for OmniGrowth Engine")
